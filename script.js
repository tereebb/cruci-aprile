const cruciverbaData = [
    { parola: "COMUNITà", start: [0, 2], direzione: "orizzontale", 
descrizione: "Lo è un gruppo di lavoratori.", classe: "blu", bloccate: [0, 7]},
    { parola: "EFFICENTE", start: [1, 4], direzione: "orizzontale", 
descrizione: "Lo deve essere un progetto / lavoro.", classe: "azzurro", bloccate: [1, 7]},
    { parola: "INCONTRI", start: [2, 5], direzione: "orizzontale", 
descrizione: "... organizzati tra colleghi.", classe: "arancione", bloccate: [3, 4]},
    { parola: "SOSTENIBILE", start: [3, 3], direzione: "orizzontale", 
descrizione: "Azienda green.", classe: "blu", bloccate: [1, 6]},
    { parola: "SOCIALNETWORK", start: [4, 4], direzione: "orizzontale", 
descrizione: "Serve per la comunicazione aziendale online.", classe: "azzurro", bloccate: [4]},
